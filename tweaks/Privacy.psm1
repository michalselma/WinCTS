...
Function DisableTelemetry {
	Write-Output "Telemetry -> Disable"
...
Function DisableSmartScreen {
	Write-Output "SmartScreen Filter -> Disable"
...
Function EnableSmartScreen {
	Write-Output "SmartScreen Filter -> Enable"
...
Function DisableWebSearch {
	Write-Output "Bing Search in Start Menu -> Disable"
...
Function EnableWebSearch {
	Write-Output "Bing Search in Start Menu -> Enable"
...
Function DisableAppSuggestions {
	Write-Output "Applications Suggestions (Content Delivery Manager) -> Disable"
...
Function EnableAppSuggestions {
	Write-Output "Applications Suggestions (Content Delivery Manager) -> Enable"
...
Function DisableActivityHistory {
	Write-Output "Activity History -> Disable"
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name "EnableActivityFeed" -Type DWord -Value 0
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name "PublishUserActivities" -Type DWord -Value 0
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name "UploadUserActivities" -Type DWord -Value 0
}
Function EnableActivityHistory {
	Write-Output "Activity History -> Enable"
...
Function DisableTailoredExperiences {
	Write-Output "Tailored Experiences With Diagnostic Data -> Disable"
...
Function EnableTailoredExperiences {
	Write-Output "Tailored Experiences With Diagnostic Data -> Enable"
	Remove-ItemProperty -Path "HKCU:\Software\Policies\Microsoft\Windows\CloudContent" -Name "DisableTailoredExperiencesWithDiagnosticData" -ErrorAction SilentlyContinue
}

#### Advertising ID
Function DisableAdvertisingID {
	Write-Output "Advertising ID -> Disable"
...
Function EnableAdvertisingID {
	Write-Output "Advertising ID -> Enable"
...
Function DisableWebLangList {
	Write-Output "Website Access to Language List -> Disable"
	Set-ItemProperty -Path "HKCU:\Control Panel\International\User Profile" -Name "HttpAcceptLanguageOptOut" -Type DWord -Value 1
}
Function EnableWebLangList {
	Write-Output "Website Access to Language List -> Enable"
...
Function DisableErrorReporting {
	Write-Output "Windows Error Reporting -> Disable"
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\Windows Error Reporting" -Name "Disabled" -Type DWord -Value 1
	Disable-ScheduledTask -TaskName "Microsoft\Windows\Windows Error Reporting\QueueReporting" | Out-Null
}
Function EnableErrorReporting {
	Write-Output "Windows Error Reporting -> Enable"
...
Function DisableDiagTrack {
	Write-Output "Diagnostics Tracking Service (Connected User Experiences and Telemetry) -> Service Stop and Disable"
	Stop-Service "DiagTrack" -WarningAction SilentlyContinue
	Set-Service "DiagTrack" -StartupType Disabled
}
Function EnableDiagTrack {
	Write-Output "Diagnostics Tracking Service (Connected User Experiences and Telemetry) -> Service Start and Enable"
...
Function DisableWAPPush {
	Write-Output "Device Management Wireless Application Protocol (WAP) Push Service -> Disable"
	Stop-Service "dmwappushservice" -WarningAction SilentlyContinue
	Set-Service "dmwappushservice" -StartupType Disabled
}
Function EnableWAPPush {
	Write-Output "Device Management Wireless Application Protocol (WAP) Push Service -> Enable"
...
Function EnableClearRecentDocsOnExit {
	Write-Output "Clear History of Recent Docs On Exit -> Enable"
...
Function DisableClearRecentDocsOnExit {
	Write-Output "Clear History of Recent Docs On Exit -> Disable"
...
Function EnableNoRecentDocsHistory {
	Write-Output "No Recent Documents History -> Enable"
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" | Out-Null
	}
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" -Name "NoRecentDocsHistory" -Type DWord -Value 1
}
Function DisableNoRecentDocsHistory {
	Write-Output "No Recent Documents History -> Disable"
