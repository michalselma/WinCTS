...
Function DisableWiFiSense {
	Write-Output "Wi-Fi Sense -> Disable"
...
Function EnableWiFiSense {
	Write-Output "Wi-Fi Sense -> Enable"
	If (!(Test-Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting")) {
		New-Item -Path "HKLM:\SOFTWARE\Microsoft\PolicyManager\default\WiFi\AllowWiFiHotSpotReporting" -Force | Out-Null
	}
...
#### Location and location scripting
Function DisableLocationAndLocationScripting {
	Write-Output "Location And Location Scripting -> Disable"
...
Function EnableLocationAndLocationScripting {
	Write-Output "Location And Location Scripting -> Enable"
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -Name "DisableLocation" -ErrorAction SilentlyContinue
	Remove-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -Name "DisableLocationScripting" -ErrorAction SilentlyContinue
}

#### Sensor features, such as screen auto rotation or GPS
Function DisableLocationSensors {
	Write-Output "Location Sensors -> Disable"
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors")) {
		New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -Force | Out-Null
	}
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors" -Name "DisableSensors" -Type DWord -Value 1
}
Function EnableLocationSensors {
	Write-Output "Location Sensors -> Enable"
...
#### Biometric features
# Note: If you log on using biometrics (Windows Hello Face Recognition, Fingerprint, Iris) it's recommended to create a password recovery disk before applying this tweak.
Function DisableBiometrics {
	Write-Output "Biometric services Windows Hello (Face Recognition, Fingerprint, Iris scanning/Mobile auth.) -> Disable"
...
Function EnableBiometrics {
	Write-Output "Biometric services Windows Hello (Face Recognition, Fingerprint, Iris scanning/Mobile auth.) -> Enable"
...
Function DisableCamera {
	Write-Output "Camera access -> Disable"
...
Function EnableCamera {
	Write-Output "Camera access -> Enable"
...
Function DisableMicrophone {
	Write-Output "Microphone access -> Disable"
	If (!(Test-Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy")) {
		New-Item -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy" -Force | Out-Null
	}
...
Function EnableMicrophone {
	Write-Output "Microphone access -> Enable"
